			...
			<div class="pcoded-main-container">
				<div class="pcoded-wrapper">
					...
					<div class="pcoded-content">
						...
						<jsp:include page="page-header-start.jsp"></jsp:include>
											...
											<form class="form-material" enctype="multipart/form-data"
												...
												<div class="form-group form-default form-static-label">
													<input type="text" name="nome" id="nome"
														...
														value="${modelLogin.nome}"> <span class="form-bar"></span>
												...
												<div class="form-group form-default form-static-label">
													<input type="text" name="login" id="login"
														class="form-control" required="required"
														autocomplete="off" value="${modelLogin.login}"> <span
												...
												<button type="button" class="btn btn-warning"
													data-toggle="modal" data-target="#ModalConsultaUsuario">
													Consultar</button>
						...
						.ajax(
								{
									...
									success : function(response) {
										...
										document
												.getElementById('totalResultadosBusca').textContent = 'Resultados: '
												+ json.length;
									}
